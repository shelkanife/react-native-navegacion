...
const ReRegistrar = ({navigation, route}) => {
    ...
    <Container style={styles.mainContainer}>
        <Header style={{backgroundColor: '#dd7554'}}>
        <Left>
        ...
        <Body>
          <Title style={{fontSize: 20}}>
            {budget? "Editar Recordatorio":"Registrar Recordatorio"}
          </Title>
        </Body>
        <Pressable 
            disabled={!isSavable}
        ...
        <Item style={localeStyles.item}>
          <Label
            style={itemStyles.label}>Nombre</Label>
          <Input 
        ...
        <View style={{flexDirection: 'row',alignItems:'center'}}>
          <View style={{width: '50%'}}>
            ...
            <Input 
              disabled 
              style={{...styles.item,...localeStyles.item,textAlign:'center',borderWidth:1,borderColor:'white',borderBottomColor:'#dd7554'}} 
